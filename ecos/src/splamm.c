 ...
 */
// x(p, n, Ajc[n], Ajc, Air, Apr);
spmat *ecoscreateSparseMatrix(idxint m, idxint n, idxint nnz, idxint *jc,
                              idxint *ir, pfloat *pr) {
 ...
 */
void permuteSparseSymmetricMatrix(spmat *A, idxint *pinv, spmat *C,
                                  idxint *PK) {
